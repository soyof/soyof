<template>
  ...
  <div class="web-info card-box">
    ...
    <div class="webinfo-item">
      <div class="webinfo-item-title">文章总数：</div>
      <div class="webinfo-content">{{ mdFileCount }} 篇</div>
    </div>

    <div class="webinfo-item" :title="createToNowDay != 0 ? `${createToNowDay} 天` : '不到一天'">
    ...
    <div class="webinfo-item" :title="totalWords">
      <div class="webinfo-item-title">本站总字数：</div>
      <div class="webinfo-content">{{ totalWords }} 字</div>
    </div>

    <div class="webinfo-item" :title="lastActiveDate == '刚刚' ? '刚刚' : lastActiveDate + '前'">
...
.webinfo-title .icon-zhandianxinxi {
